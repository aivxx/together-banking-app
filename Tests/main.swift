...
let detectedAmex = StatementParser.detectAccount("American Express Rewards Checking Statement\nAccount Ending: *0500 Account Name: Rewards Checking\nAccount Activity\nOnline transfer from Bank of America")
check(detectedAmex?.name(for: .checking) == "American Express Checking · 0500", "Account name auto-detected from statement header and masked suffix")
